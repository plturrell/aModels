...
func ValidateNodes(nodes []graph.Node, logger *log.Logger) ValidationResult {
...
func ValidateEdges(edges []graph.Edge, nodes []graph.Node, logger *log.Logger) ValidationResult {
	result := ValidationResult{
		Valid:    true,
		Errors:   []string{},
		Warnings: []string{},
...
func ValidateGraph(nodes []graph.Node, edges []graph.Edge, logger *log.Logger) ValidationResult {
...
func FilterValidNodes(nodes []graph.Node, validationResult ValidationResult) []graph.Node {
...
func FilterValidEdges(edges []graph.Edge, validationResult ValidationResult) []graph.Edge {
	if validationResult.Valid {
		return edges
	}
