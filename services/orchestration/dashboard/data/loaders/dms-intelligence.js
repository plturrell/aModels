/**
 * Data loader for DMS intelligence data
 * Fetches intelligence data (relationships, patterns, knowledge graph) from DMS API
 */
...
export default async function(requestId) {
  ...
  const url = `${apiBase}/api/dms/results/${requestId}/intelligence`;
  ...
  try {
    ...
    console.error("Error loading DMS intelligence:", error);
