---
title: Murex Results Dashboard
description: Explore processed trades, relationships, and intelligence
---

```js
import * as Plot from "@observablehq/plot";
import murexResultsData from "../data/loaders/murex-results.js";
import murexIntelligenceData from "../data/loaders/murex-intelligence.js";
import {html} from "@observablehq/stdlib";
import {emptyStateNoRequest, emptyStateError} from "../components/emptyState.js";
```

# Murex Results Dashboard

<div class="fade-in">

Explore processed Murex trades, discover relationships, and understand intelligence extracted from your trading data.
...
if (requestId) {
  try {
    results = await murexResultsData(requestId);
  ...
  try {
    intelligence = await murexIntelligenceData(requestId);
...
```js
html`<div class="card">
  <h3>Processed Trades (${results?.documents?.length || 0})</h3>
