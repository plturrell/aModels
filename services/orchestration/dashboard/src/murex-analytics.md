---
title: Murex Analytics Dashboard
description: Analyze trends, patterns, and domain distributions
---

```js
import * as Plot from "@observablehq/plot";
import murexAnalyticsData from "../data/loaders/murex-analytics.js";
import {html} from "@observablehq/stdlib";
```

# Murex Analytics Dashboard

<div class="fade-in">

Analyze trends, discover patterns, and understand your Murex trade processing performance.
...
```js
const analytics = await murexAnalyticsData();
```
