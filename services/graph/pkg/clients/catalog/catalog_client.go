...
// This replaces the direct package import pattern.
...
func (c *CatalogClient) RegisterDataElement(ctx context.Context, element DataElementRequest) error {
	...
	if err != nil {
		...
		// Return error but allow caller to decide if it's fatal
		return fmt.Errorf("catalog service request failed: %w", err)
	}
...
// ConvertISO11179ToRequest converts an ISO 11179 DataElement to a request.
func ConvertISO11179ToRequest(element *iso11179.DataElement) DataElementRequest {
