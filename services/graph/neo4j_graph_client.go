...
func (c *Neo4jGraphClient) upsertNodesBatch(ctx context.Context, nodes []DomainNode, batchSize int) error {
...
func (c *Neo4jGraphClient) upsertEdgesBatch(ctx context.Context, edges []DomainEdge, batchSize int) error {
