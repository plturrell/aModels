module.exports = {
  ...
  moduleNameMapper: {
    "^@/(.*)$": "<rootDir>/src/$1",
    "^@/components/common/genericIconComponent$": "<rootDir>/src/__mocks__/genericIconComponent.tsx",
    "^@/icons/BotMessageSquare$": "<rootDir>/src/__mocks__/BotMessageSquare.tsx",
    "^@/stores/darkStore$": "<rootDir>/src/__mocks__/darkStore.ts",
