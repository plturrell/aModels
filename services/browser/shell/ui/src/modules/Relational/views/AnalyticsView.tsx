/**
 * Relational Analytics View
 * Displays analytics and history for relational processing
 */
...
import type { RelationalRequestHistory } from "../../../api/relational";

interface AnalyticsViewProps {
  history: RelationalRequestHistory | null;
  loading: boolean;
  error: string | null;
  onRefresh: () => void;
}
