/**
 * Relational Processing View
 * Displays processing status for relational table requests
 */
...
import type { RelationalProcessingRequest } from "../../../api/relational";

interface ProcessingViewProps {
  requestId: string;
  statusData: RelationalProcessingRequest | null;
  loading: boolean;
  error: string | null;
