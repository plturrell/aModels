// Package hanapool provides HANA connection pool functionality
// This is a local implementation that wraps the SAP go-hdb driver
...
// This allows HANA to be used as an external data source.
type Pool struct {
	db     *sql.DB
	config Config
}
